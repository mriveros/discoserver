        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="http://localhost/disco/web/menu.php" value="Load new document" onclick="location.reload();"><i class="fa  fa-tasks"></i> Menu Principal</a>
                        </li>
			<li>
                            <a href="#"><i class="fa fa-user"></i> USUARIOS<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/disco/web/usuarios/ABMusuario.php">Registros de Usuarios</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
			<li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/disco/web/informes/frmResumenCompras.php">Resumen Compras</a>
                                </li>
                                <li>
                                    <a href="http://localhost/disco/web/informes/frmResumenPagos.php">Resumen Pagos</a>
                                </li>
                                 <li>
                                    <a href="http://localhost/disco/web/informes/frmResumenComprasProveedor.php">Resumen Compras-Proveedor</a>
                                </li>
                                <li>
                                    <a href="http://localhost/disco/web/informes/frmResumenPagosProveedor.php">Resumen Pagos-Proveedor</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
